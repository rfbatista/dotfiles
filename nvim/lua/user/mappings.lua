...
local mappings = {
	...
	l = {
		...
		b = { "<cmd>TypescriptOrganizeImports<CR>", "Organize imports" },
		c = { "<cmd>TypescriptRenameFile<CR>", "Typescript Rename File" },
		d = { "<cmd>TypescriptAddMissingImports<CR>", "Import all" },
		e = { "<cmd>TypescriptFixAll<CR>", "Fix all" },
		m = { "<cmd>TypescriptRemoveUnused<CR>", "Remover imports nao utilizados" },
		-- e = { "<cmd>Prettier<CR>", "Prettier" },
		-- f = { "<cmd>PrettierCliPath<CR>", "Prettier beeing used" },
		f = { "<cmd>lua _FORMAT_CODE()<cr>", "Format" },
		g = { "<cmd>TypescriptGoToSourceDefinition<cr>", "Go to definition" },
		h = {
